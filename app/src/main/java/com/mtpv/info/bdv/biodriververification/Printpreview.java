       ...
       // print=(WebView)findViewById(R.id.print);
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent back = new Intent(getApplicationContext(),MenuBorad.class);
                startActivity(back);
                //ed_appID , ed_aadharnum
                MenuBorad.ed_appID.setText("");
                MenuBorad.ed_aadharnum.setText("");
            }
        });
        ...
        String pdfFile=extStorageDirectory+File.separator+"Driver"+File.separator+date+File.separator+ServiceHelper.final_data_master[2]+".pdf";
      ...
      //  Log.i("PDF_Path-->",""+path);
        ...
        try {
            ...
            if (file.exists()) {
                ...
                Toast.makeText(Printpreview.this, "File NotFound",Toast.LENGTH_SHORT).show();
            }
        } catch (ActivityNotFoundException e) {
            Toast.makeText(Printpreview.this,"No Viewer Application Found", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            e.printStackTrace();
        }
