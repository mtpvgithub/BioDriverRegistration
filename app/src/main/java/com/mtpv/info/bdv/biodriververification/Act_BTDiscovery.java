...
public class Act_BTDiscovery extends Activity implements OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        storage =new Storage(Act_BTDiscovery.this);
    ...
    protected void showDevices(){
        ...
        while (e.hasMoreElements()){
           ...
           /* Log.i("MAC", sKey);
            Log.i("NAME", this.mhtFDS.get(sKey).get("NAME"));
            Log.i("RSSI", this.mhtFDS.get(sKey).get("RSSI"));
            Log.i("COD", this.mhtFDS.get(sKey).get("COD"));
            Log.i("BOND", this.mhtFDS.get(sKey).get("BOND"));
            Log.i("DEVICE_TYPE", toDeviceTypeString(this.mhtFDS.get(sKey).get("DEVICE_TYPE")));*/
            storage.saveSecure(Constants.BT_ADDRESS,sKey);
